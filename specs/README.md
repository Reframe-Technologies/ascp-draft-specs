...
4. **Distribution** – Integrate secure channels and synchronization via [`ascp-channels-secure-distribution-layer.md`](./ascp-channels-secure-distribution-layer.md) and [`ascp-logsync-protocol-alsp.md`](./ascp-logsync-protocol-alsp.md)
